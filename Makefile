...
.PHONY: build-swift run-swift build-image remove-image export-image import-image run-app stop-app remove-app connect logs delete-image restart scp deploy build-export-scp-deploy
